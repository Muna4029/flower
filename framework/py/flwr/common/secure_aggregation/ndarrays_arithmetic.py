...
def factor_combine(factor: int, parameters: list[np.ndarray[Any, Any]]) -> list[np.ndarray[Any, Any]]:
...
def get_parameters_shape(parameters: list[np.ndarray[Any, Any]]) -> list[tuple[int, ...]]:
    """Get dimensions of each NDArray in parameters."""
    return [arr.shape for arr in parameters]


def get_zero_parameters(
    dimensions_list: list[tuple[int, ...]], dtype: type = np.int64
...
def parameters_addition(
    parameters1: list[np.ndarray[Any, Any]], parameters2: list[np.ndarray[Any, Any]]
) -> list[np.ndarray[Any, Any]]:
    """Add two parameters."""
...
def parameters_mod(parameters: list[np.ndarray[Any, Any]], divisor: int) -> list[np.ndarray[Any, Any]]:
...
def parameters_multiply(
    parameters: list[np.ndarray[Any, Any]], multiplier: Union[int, float]
) -> list[np.ndarray[Any, Any]]:
...
def parameters_divide(
    parameters: list[np.ndarray[Any, Any]], divisor: Union[int, float]
) -> list[np.ndarray[Any, Any]]:
